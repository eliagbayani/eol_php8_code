...
php update_resources/connectors/resource_utility.php _ '{"resource_id": "Smith_et_al_2011_meta_recoded", "task": "metadata_recoding"}'
-> case where lifeStage is a col in MoF => move to a col in occurrence.
...
elseif($task == 'report_4_Wikipedia_EN_traits') { //for Jen: https://eol-jira.bibalex.org/browse/DATA-1858?focusedCommentId=65155&page=com.atlassian.jira.plugin.system.issuetabpanels:comment-tabpanel#comment-65155
    $dwca_file = DOC_ROOT . '/applications/content_server/resources/wikipedia_en_traits.tar.gz';
    // $dwca_file = DOC_ROOT . '/applications/content_server/resources/708.tar.gz'; //testing investigation only
}
elseif($task == 'add_canonical_in_taxa') {
    if($resource_id == 'WoRMS2EoL_zip') {
        ...
        else                            $dwca_file = DOC_ROOT . "/applications/content_server/resources/".$resource_id.".tar.gz";
...
elseif($task == 'remove_MoF_without_taxa') {
    if($resource_id == '26_ENV_2') {
        ...
        else                            $dwca_file = DOC_ROOT . "/applications/content_server/resources/26_ENV.tar.gz";
    }
}
elseif($task == 'remove_MoF_without_taxa_REAL') {
    if($resource_id == '26_ENV_3') {
        if(Functions::is_production())  exit("\nNot yet run.\n");//not yet run in editors.eol.org
        else                            $dwca_file = DOC_ROOT . "/applications/content_server/resources/26_ENV_2.tar.gz";
    }
}
...
elseif($task == 'metadata_recoding') {
    if($resource_id == '692_meta_recoded') {
        ...
        else                            $dwca_file = DOC_ROOT . "/applications/content_server/resources/692.tar.gz";
    }
    elseif($resource_id == '201_meta_recoded') {
        ...
        else                            $dwca_file = DOC_ROOT . "/applications/content_server/resources/201.tar.gz";
    }
    ...
    elseif($resource_id == '726_meta_recoded') {
        ...
        else                            $dwca_file = DOC_ROOT . "/applications/content_server/resources/726.tar.gz";
    }
    elseif($resource_id == 'griis_meta_recoded') {
        ...
        else                            $dwca_file = DOC_ROOT . "/applications/content_server/resources/griis.tar.gz";
    }
    elseif($resource_id == '770_meta_recoded') {
        ...
        else                            $dwca_file = DOC_ROOT . "/applications/content_server/resources/770_2020_Sep15.tar.gz";
    }
    ...
    elseif($resource_id == 'natdb_meta_recoded_1') {
        ...
        else                            $dwca_file = DOC_ROOT . "/applications/content_server/resources/natdb.tar.gz";
    }
    elseif($resource_id == 'natdb_meta_recoded') {
        ...
        else                            $dwca_file = DOC_ROOT . "/applications/content_server/resources/natdb_meta_recoded_1.tar.gz";
    }
    ...
    elseif($resource_id == 'copepods_meta_recoded') {
        ...
        else                            $dwca_file = DOC_ROOT . "/applications/content_server/resources/copepods.tar.gz";
    }
    elseif($resource_id == '42_meta_recoded') {
        ...
        else                            $dwca_file = DOC_ROOT . "/applications/content_server/resources/42.tar.gz";
    }
    elseif($resource_id == '727_meta_recoded') {
        ...
        else                            $dwca_file = DOC_ROOT . "/applications/content_server/resources/727.tar.gz";
    }
    ...
    elseif($resource_id == '707_meta_recoded') {
        ...
        else                            $dwca_file = DOC_ROOT . "/applications/content_server/resources/707.tar.gz";
    }
    ...
    elseif($resource_id == 'AnAge_meta_recoded')              { $dwca_file = CONTENT_RESOURCE_LOCAL_PATH."/AnAge.tar.gz"; }
    elseif($resource_id == 'Smith_et_al_2011_meta_recoded')   { $dwca_file = CONTENT_RESOURCE_LOCAL_PATH."/Smith_et_al_2011.tar.gz"; }
    ...
    elseif($resource_id == 'cotr_meta_recoded_1') {
        ...
        else                            $dwca_file = DOC_ROOT . "/applications/content_server/resources/cotr.tar.gz";
    }
    elseif($resource_id == 'cotr_meta_recoded') {
        ...
        else                            $dwca_file = DOC_ROOT . "/applications/content_server/resources/cotr_meta_recoded_1.tar.gz";
    }
    elseif($resource_id == 'cotr_meta_recoded_final') {
        ...
        else                            $dwca_file = DOC_ROOT . "/applications/content_server/resources/cotr_meta_recoded.tar.gz";
    }

    elseif($resource_id == 'test_meta_recoded') { //task_45: no actual resource atm.
        $dwca_file = DOC_ROOT . "/applications/content_server/resources/test_mUnit_sMethod.zip";
    }
    elseif($resource_id == 'test2_meta_recoded') { //task_45: first client is WorMS (26).
        $dwca_file = DOC_ROOT . "/applications/content_server/resources/test_mUnit_sMethod_asChildInMoF.zip";
    }
    elseif($resource_id == 'test3_meta_recoded') { //task_67: first client is WorMS (26).
        $dwca_file = DOC_ROOT . "/applications/content_server/resources/test_lifeStage_sex_asChildInMoF.zip";
    }
    ...
    elseif($resource_id == '26_meta_recoded_1') { //task_45: statisticalMethod | measurementUnit
        ...
        else                            $dwca_file = DOC_ROOT . "/applications/content_server/resources/26.tar.gz";
    }
    ...
    elseif($resource_id == '200_meta_recoded') { //task_200: contributor, creator, publisher from Document to Agents
        $dwca_file = DOC_ROOT."/applications/content_server/resources/200.tar.gz";
    }
    ...
    elseif($resource_id == 'plant_growth_form_meta_recoded') { //task_move_col_in_occurrence_to_MoF_row_with_MeasurementOfTaxon_false
        ...
        $dwca_file = DOC_ROOT . "/applications/content_server/resources/plantgrowthformmetarecoded.tar.gz";
...
elseif($task == 'fix_MoF_child_records') { // 1st client for this task
    if($resource_id == 'Plant_Growth_Form') {
        ...
        else                            $dwca_file = DOC_ROOT . "/applications/content_server/resources/plantgrowthformmetarecoded.tar.gz";
