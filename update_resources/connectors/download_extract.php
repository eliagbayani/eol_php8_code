...
$params['url'] = WEB_ROOT."//applications/content_server/resources_3/xeno_canto.tar.gz";
// $params['url'] = WEB_ROOT."//applications/content_server/resources_3/37.tar.gz";
// $params['url'] = WEB_ROOT."//applications/content_server/resources_3/sample.zip";
// $params['url'] = WEB_ROOT."//applications/content_server/resources_3/sample_no_folder.zip";
