...
*/
class MakeUnique_measurementIDs
{
    ...
    function start($info)
    {
        ...
        self::process_generic_table($tables['http://rs.tdwg.org/dwc/terms/measurementorfact'][0], 'make_unique_measurementID');
    }
    ...
    {   //print_r($meta);
        ...
        foreach(new FileIterator($meta->file_uri) as $line => $row) {
            ...
            if($what == 'make_unique_measurementID') {
                ...
                $measurementID = Functions::generate_measurementID($o, $this->resource_id);
                $o->measurementID = $measurementID;
                if(!isset($unique[$measurementID])) {
