...
$params['url'] = DOC_ROOT."//applications/content_server/resources/xeno_canto.tar.gz";
// $params['url'] = DOC_ROOT."//applications/content_server/resources/37.tar.gz";
// $params['url'] = DOC_ROOT."//applications/content_server/resources/sample.zip";
// $params['url'] = DOC_ROOT."//applications/content_server/resources/sample_no_folder.zip";
