...
function process_resource_url($dwca_file, $resource_id, $timestart)
{
    ...
    if($undefined) echo "\nERROR: integrity-check 2: There is undefined taxonID(s) in OCCURRENCE.tab: ".count($undefined)."\n";
    else           echo "\nintegrity-check 2 OK: All taxonID(s) in OCCURRENCE.tab have TAXON entries.\n";
