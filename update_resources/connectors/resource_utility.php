...
if($task == 'remove_taxa_without_MoF') {
    if(Functions::is_production()) $dwca_file = '/u/scripts/eol_php_code/applications/content_server/resources/'.$resource_id.'.tar.gz';
        ...
        $dwca_file = WEB_ROOT . '/applications/content_server/resources_3/'.$resource_id.'.tar.gz';
    }
    // /* ---------- customize here ----------
...
elseif($task == 'report_4_Wikipedia_EN_traits') { //for Jen: https://eol-jira.bibalex.org/browse/DATA-1858?focusedCommentId=65155&page=com.atlassian.jira.plugin.system.issuetabpanels:comment-tabpanel#comment-65155
    $dwca_file = WEB_ROOT . '/applications/content_server/resources_3/wikipedia_en_traits.tar.gz';
    // $dwca_file = WEB_ROOT . '/applications/content_server/resources_3/708.tar.gz'; //testing investigation only
}
...
elseif($task == 'metadata_recoding') {
    if($resource_id == '692_meta_recoded') {
        ...
        else                            $dwca_file = WEB_ROOT . "/applications/content_server/resources_3/692.tar.gz";
    }
    elseif($resource_id == '201_meta_recoded') {
        ...
        else                            $dwca_file = WEB_ROOT . "/applications/content_server/resources_3/201.tar.gz";
    }
    ...
    elseif($resource_id == '726_meta_recoded') {
        ...
        else                            $dwca_file = WEB_ROOT . "/applications/content_server/resources_3/726.tar.gz";
    }
    ...
    elseif($resource_id == 'natdb_meta_recoded_1') {
        ...
        else                            $dwca_file = WEB_ROOT . "/applications/content_server/resources_3/natdb.tar.gz";
    }
    elseif($resource_id == 'natdb_meta_recoded') {
        ...
        else                            $dwca_file = WEB_ROOT . "/applications/content_server/resources_3/natdb_meta_recoded_1.tar.gz";
    }
    ...
    elseif($resource_id == 'copepods_meta_recoded') {
        ...
        else                            $dwca_file = WEB_ROOT . "/applications/content_server/resources_3/copepods.tar.gz";
    }
    elseif($resource_id == '42_meta_recoded') {
        ...
        else                            $dwca_file = WEB_ROOT . "/applications/content_server/resources_3/42.tar.gz";
    }
    elseif($resource_id == '727_meta_recoded') {
        ...
        else                            $dwca_file = WEB_ROOT . "/applications/content_server/resources_3/727.tar.gz";
    }
    ...
    elseif($resource_id == '707_meta_recoded') {
        ...
        else                            $dwca_file = WEB_ROOT . "/applications/content_server/resources_3/707.tar.gz";
    }
    ...
    elseif($resource_id == 'try_dbase_2024_meta_recoded') {
        ...
        else                            $dwca_file = WEB_ROOT . "/applications/content_server/resources_3/try_dbase_2024.tar.gz";
    }
    ...
    elseif($resource_id == 'cotr_meta_recoded_1') {
        ...
        else                            $dwca_file = WEB_ROOT . "/applications/content_server/resources_3/cotr.tar.gz";
    }
    elseif($resource_id == 'cotr_meta_recoded') {
        ...
        else                            $dwca_file = WEB_ROOT . "/applications/content_server/resources_3/cotr_meta_recoded_1.tar.gz";
    }
    elseif($resource_id == 'cotr_meta_recoded_final') {
        ...
        else                            $dwca_file = WEB_ROOT . "/applications/content_server/resources_3/cotr_meta_recoded.tar.gz";
    }

    elseif($resource_id == 'test_meta_recoded') { //task_45: no actual resource atm.
        $dwca_file = WEB_ROOT . "/applications/content_server/resources_3/test_mUnit_sMethod.zip";
    }
    elseif($resource_id == 'test2_meta_recoded') { //task_45: first client is WorMS (26).
        $dwca_file = WEB_ROOT . "/applications/content_server/resources_3/test_mUnit_sMethod_asChildInMoF.zip";
    }
    elseif($resource_id == 'test3_meta_recoded') { //task_67: first client is WorMS (26).
        $dwca_file = WEB_ROOT . "/applications/content_server/resources_3/test_lifeStage_sex_asChildInMoF.zip";
    }
    ...
    elseif($resource_id == 'plant_growth_form_meta_recoded') { //task_move_col_in_occurrence_to_MoF_row_with_MeasurementOfTaxon_false
        ...
        $dwca_file = WEB_ROOT . "/applications/content_server/resources_3/plantgrowthformmetarecoded.tar.gz";
    ...
    elseif($resource_id == 'circa_meta_recoded') { //CCP and occurrence2MoF
        ...
        $dwca_file = WEB_ROOT . "/applications/content_server/resources_3/local_circa.tar.gz";
...
elseif($task == 'fix_MoF_child_records') { // 1st client for this task
    if($resource_id == 'Plant_Growth_Form') {
        ...
        else                            $dwca_file = WEB_ROOT . "/applications/content_server/resources_3/plantgrowthformmetarecoded.tar.gz";
