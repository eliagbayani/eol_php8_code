...
class Annotator2EOLAPI extends Functions_Annotator
{
    function __construct($param)
    {
        ...
        */
        ...
        $this->descendants_habitat_group['saline water'] = 'https://github.com/EOL/textmine_rules/raw/refs/heads/main/AmphibiaWeb/descendants_of_saline_water.tsv'; //new by Katja: 6Dec2025
    ...
    {   //print_r($meta);
        ...
        foreach(new FileIterator($meta->file_uri) as $line => $row) { //main loop
            ...
            if(self::valid_record($rec)) {
                ...
                growth: Smithsonian Contributions to Botany
                        BHL_plants
                e.g. https://api.pensoft.net/annotator?text=I%20like%20playing%20in%20the%20shrub&ontologies=growth

                WoRMS with title == 'distribution' => eol-geonames
