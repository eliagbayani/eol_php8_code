...
class IrmngAPI
{
    function __construct($folder = null, $zip_path)
    {
        ...
        // $this->taxa_with_blank_status_dump_file                   = LOCAL_HOST."/cp_new/IRMNG/taxa_with_blank_status.txt";
        // $this->taxa_with_blank_status_but_with_eol_page_dump_file = LOCAL_HOST."/cp_new/IRMNG/taxa_with_blank_status_but_with_eol_page.txt";
