...
class Clean_MoF_Habitat_API
{
    ...
    function start($info)
    {
        ...
        */
        ...
        elseif(in_array($this->resource_id, array('26_delta_new', '21_cleaned_MoF_habitat', '22_cleaned_MoF_habitat', '24_cleaned_MoF_habitat', 'AntWeb_ENV_3'))) { //don't delete taxon, references
            unset($this->occurrenceIDs_2delete);
            unset($this->referenceIDs);
        }
