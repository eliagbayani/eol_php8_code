...
if(Functions::is_production()) {
    ...
    $info[$resource_id] = array('dwca_file' => WEB_ROOT."/applications/content_server/resources/".$resource_id.".tar.gz");
    // -> above line is default, should go first
    $info['itis_2019-08-28'] = array('dwca_file' => WEB_ROOT.'/applications/content_server/resources/itis_2019-08-28.tar.gz');
    $info['itis_2020-07-28'] = array('dwca_file' => WEB_ROOT.'/applications/content_server/resources/itis_2020-07-28.tar.gz');
    $info['itis_2020-12-01'] = array('dwca_file' => WEB_ROOT.'/applications/content_server/resources/itis_2020-12-01.tar.gz');
    $info['368_final'] = array('dwca_file' => WEB_ROOT.'/applications/content_server/resources/368_removed_aves.tar.gz');
}
