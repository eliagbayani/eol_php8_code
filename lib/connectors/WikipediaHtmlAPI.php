...
class WikipediaHtmlAPI
{
    ...
    private function generate_main_html_page()
    {
        ...
        if($files) {
            ...
            print_r($files);
            /* Array(
                [0] => /opt/homebrew/var/www/eol_php_code/applications/content_server/resources/reports/wikipedia_html/80.html
                [1] => /opt/homebrew/var/www/eol_php_code/applications/content_server/resources/reports/wikipedia_html/ceb.html
                [2] => /opt/homebrew/var/www/eol_php_code/applications/content_server/resources/reports/wikipedia_html/nl.html
            )*/
